...
[<assembly: AssemblyTitleAttribute("LittleFSharpTyper.Tests")>]
[<assembly: AssemblyProductAttribute("LittleFSharpTyper")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "LittleFSharpTyper.Tests"
    let [<Literal>] AssemblyProduct = "LittleFSharpTyper"
